                                            ...
                                            <div class="body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="ad" name="ad" value="{{ $mekan->ad }}" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <textarea type="text" class="form-control" id="icerik" name="icerik">{{ $mekan->icerik }}</textarea>
