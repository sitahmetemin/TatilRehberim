                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#home_with_icon_title" data-toggle="tab">
                                <i class="material-icons">reorder</i> Yemek
                            </a>
                        </li>
                    </ul>
                                            ...
                                            <div class="body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="ad" name="ad" value="{{ $yemek->ad }}" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <textarea type="text" class="form-control" id="aciklama" name="aciklama">{{ $yemek->aciklama }}</textarea>
