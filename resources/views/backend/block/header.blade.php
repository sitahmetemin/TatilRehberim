...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="/assets/backend/favicon.ico" type="image/x-icon">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/admin">TATİL REHBERİM ADMİN PANELİ</a>
        </div>
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <!-- Call Search -->
                <li><a href="/" target="_blank" title="Site Ön İzle"><i class="material-icons">home</i></a></li>
